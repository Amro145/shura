...
export default function SignInPage() {
  const { signIn } = useAuthActions() ?? { signIn: undefined };
      ...
      <div className="w-full max-w-md p-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            disabled={!signIn}
            className="flex w-full items-center justify-center gap-3 rounded-lg bg-gray-800 px-4 py-3 text-white transition-colors hover:bg-gray-700 disabled:opacity-50"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5">
